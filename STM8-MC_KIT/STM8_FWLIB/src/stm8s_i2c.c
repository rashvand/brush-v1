...
/**
  ...
  * This example shows how to call the function:
  * @code
  * I2C_Init(I2C_DUTYCYCLE_2, I2C_ACK_CURR, I2C_ADDMODE_7BIT, 0xA0, 50, 400000);
  * @endcode
  */
...
/**
  ...
  * This example shows how to call the function:
  * @code
  * I2C_Send7bitAddress(0xA8, I2C_DIRECTION_TX);
  * @endcode
  */
...
/**
  ...
  * @code
  * ITStatus status;
  * status = I2C_GetITStatus(I2C_ITPENDINGBIT_ADDRESSSENTMATCHED);
  * @endcode
  */
