  ...
  48                     ; 20 @far @interrupt void NonHandledInterrupt (void)
  48                     ; 21 {
 ...
 115  0035 00            	dc.b	page(f_TIM1_SystemTickISR)
 116  0036 0000          	dc.w	f_TIM1_SystemTickISR
 ...
 159  0061 00            	dc.b	page(f_ADC1_ISR)
 160  0062 0000          	dc.w	f_ADC1_ISR
