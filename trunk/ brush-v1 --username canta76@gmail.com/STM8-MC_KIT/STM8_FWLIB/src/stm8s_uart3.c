...
#pragma section (UART3_CODE)
#pragma section const {UART3_CONST}
#pragma section @near [UART3_URAM]
#pragma section @near {UART3_IRAM}
#pragma section @tiny [UART3_UZRAM]
#pragma section @tiny {UART3_IZRAM}
#endif
 ...
 * @par Example:
 * @code
 * UART3_ITConfig(UART3_IT_PE, ENABLE)
 * @endcode
 */
...
/**
  ...
  * @par Example:
  * @code
  * UART3_ReceiverWakeUpCmd(DISABLE);
  * @endcode
  */
