...
/**
  ...
  * None
  * @par Example:
  * Initialize TIM4 registers according to the specified parameters.
  * @code
  * TIM4_Prescaler_TypeDef My_Prescaler = TIM4_PRESCALER_1;
  * u8 My_Period = 0x7F;
  * TIM4_TimeBaseInit(My_Prescaler, My_Period);
  * @endcode
  */
...
/**
  ...
  * None
  * @par Example:
  * Configure the TIM4 event to be generated by software.
  * @code
...
/**
  ...
  * FlagValue = TIM4_GetFlagStatus(TIM4_FLAG_UPDATE);
  * @endcode
  */
...
/**
  ...
  * @code
  * ITStatus ITValue;
  * ITValue = TIM4_GetITStatus(TIM4_IT_UPDATE);
  * @endcode
  */
